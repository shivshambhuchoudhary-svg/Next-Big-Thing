...
import { ArrowRight, Store, ExternalLink } from 'lucide-react';
          ...
          <div className="relative z-10">
              ...
              <section key={section.id} className="min-h-[150vh] flex flex-col items-center justify-center px-8 relative">
                ...
                >
                  <div className="mb-6 flex justify-center">
                    ...
                    <span className="mx-6 text-[10px] font-mono text-[#D4AF37] tracking-[1em] uppercase">0{idx + 1} // {section.id}</span>
                    <div className="h-[1px] w-24 bg-[#D4AF37]/50 mt-4"></div>
                  </div>
                  ...
                  <div className="flex flex-col items-center">
                    ...
                    {/* 3D MAP INTEGRATION */}
                    {section.isMap && (
                      <div className="w-full h-[600px] mt-12 mb-12 relative">
                         <DubaiMallMap />
                         <div className="absolute bottom-4 left-1/2 -translate-x-1/2 text-[10px] font-mono text-[#D4AF37]/50 uppercase tracking-[0.3em] flex items-center space-x-2">
                            <span>Interact to Explore zones</span>
            ...
            <section className="min-h-screen flex flex-col items-center justify-center px-8 bg-gradient-to-b from-transparent to-[#D4AF37]/5 relative overflow-hidden">
              ...
              <footer className="absolute bottom-12 left-0 right-0 text-center text-[10px] font-mono text-white/20 uppercase tracking-[1.5em]">
                Built for Dubai Core &bull; Simulation 0x89A &bull; Cinematic Story
              </footer>
            </section>
          </div>
